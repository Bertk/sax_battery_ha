...
class SAXBatteryCoordinator(DataUpdateCoordinator[dict[str, Any]]):
    ...
    def _calculate_errors_per_hour(self) -> float:
    ...
    def _log_cycle_statistics(self) -> None:
    ...
    def _log_error_statistics(self) -> None:
