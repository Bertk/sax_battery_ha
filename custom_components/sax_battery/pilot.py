    ...
    async def set_solar_charging(self, enabled: bool) -> bool:
        ...
        try:
            ...
            if success:
                ...
                _LOGGER.error("Failed to set solar charging to %s", enabled)
    ...
    async def set_manual_control(self, enabled: bool) -> bool:
        ...
        try:
            ...
            if success:
                ...
                _LOGGER.error("Failed to set manual control to %s", enabled)
...
class SAXBatterySolarChargingSwitch(
    ...
    def __init__(
        ...
        if hasattr(pilot_item, "description") and pilot_item.description:
            if hasattr(pilot_item.description, "icon"):
                self._attr_icon = pilot_item.description.icon
