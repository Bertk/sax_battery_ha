...
from custom_components.sax_battery.entity_helpers import (
    build_entity_list,
...
class TestEntityHelpers:
    ...
    @patch("custom_components.sax_battery.entity_helpers.SAXBatterySensor")
    ...
    @patch("custom_components.sax_battery.entity_helpers.SAXBatterySwitch")
