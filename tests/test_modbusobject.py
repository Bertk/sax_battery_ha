...
class TestSAXBatteryNumber:
    ...
    def test_number_init(
        ...
        assert number._battery_id == "bess_a"
    ...
    def test_extra_state_attributes(
        ...
        assert attributes["battery_id"] == "bess_a"
...
class TestSAXBatteryNumberUniqueIdAndName:
    ...
    def mock_coordinator_unique_id_test(self, mock_hass_number):
        ...
        # Mock sax_data with proper get_unique_id_for_item implementation
        coordinator.sax_data = MagicMock()
        ...
        coordinator.sax_data.get_unique_id_for_item = MagicMock(
            side_effect=mock_get_unique_id
        )

        # Mock get_device_info to return dict (DeviceInfo), not SAXDeviceInfo dataclass
        coordinator.sax_data.get_device_info = MagicMock(
            return_value={
